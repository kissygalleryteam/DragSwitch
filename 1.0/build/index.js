...
gallery/dragswitch/1.0/main
gallery/dragswitch/1.0/index

*/
// Generated by CoffeeScript 1.6.3
(function() {
  KISSY.add('gallery/dragswitch/1.0/main',function(S, Node, Event, UA) {
    ...
    return DragSwitch = (function() {
      ...
      DragSwitch.prototype.touchStart = function(e) {
        ...
        this.enabled = this.config.isEnabled ? this.config.isEnabled() : true;
        if (!this.enabled) {
          return;
        }
      ...
      DragSwitch.prototype.touchMove = function(e) {
        ...
        if (!this.isSendStart && angleDelta > this.tanAngel && 1 / angleDelta > this.tanAngel) {
          ...
          this.enabled = (function() {
            if (_this.effectBind.isEnabled) {
              return _this.effectBind.isEnabled.call(_this, e);
            } else {
              return true;
            }
          })();
